...
module "beam_build_proj" {
  source = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v54.1.0"
  name   = var.project_id
  services = [
...
module "beam_build_registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v54.1.0"
