...
module "beam_build_proj" {
  source = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v50.0.0"
  name   = var.project_id
  services = [
...
module "beam_build_registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v50.0.0"
