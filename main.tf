...
module "beam_build_proj" {
  source = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v47.0.0"
  name   = var.project_id
  services = [
...
module "beam_build_registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v47.0.0"
